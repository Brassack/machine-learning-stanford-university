...
let normalisation = LinearRegression.featureNormalisation(data2X)
...
theta = LinearRegression.gradientDescent(withAlpha: alpha2, iterations: iterations2, x: gradientDescentX2, y: data2Y, theta: theta)
...
var neTheta = LinearRegression.normalEquations(x: neX2, y: data2Y)
